...
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no">
  ...
  <script src="http://localhost/tpdemo/1/Application/Home/Public/js/jquery.slimscroll.min.js"></script> 
  <script type="text/javascript" src="http://localhost/tpdemo/1/Application/Home/Public/bootstrap/js/bootstrap.min.js"></script>
  <script  src="http://localhost/tpdemo/1/Application/Home/Public/js/jquery-validate.js"></script>
 <script  src="http://localhost/tpdemo/1/Application/Home/Public/js/users.js"></script>
  <script  src="http://localhost/tpdemo/1/Application/Home/Public/js/validator.js"></script>
  <script  src="http://localhost/tpdemo/1/Application/Home/Public/js/index.js"></script>
  <script type="text/javascript" src="http://localhost/tpdemo/1/Application/Home/Public/js/jquery.my-modal.1.1.js"></script>
  <link href="http://localhost/tpdemo/1/Application/Home/Public/css/validator.css" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="http://localhost/tpdemo/1/Application/Home/Public/bootstrap/css/bootstrap.min.css"/>
  <link rel="stylesheet" type="text/css" href="http://localhost/tpdemo/1/Application/Home/Public/css/font-awesome.min.css"/>
  <link rel="stylesheet" type="text/css" href="http://localhost/tpdemo/1/Application/Home/Public/css/jquery.my-modal.1.1.winStyle.css" />
</head>
<body>
<style>
* { margin: 0; padding: 0 }
              ...
              <div id="addCommodityIndex">
                <div class="input-group row">
                    <div class="col-sm-12 big-photo">
                      <div id="preview1">
                            <img id="imghead1" border="0" src="http://localhost/tpdemo/1/Application/Home/Public/images/photo_icon.png" width="50" height="50"  onclick="$('#previewImg1').click();">
                         </div>         
            ...
            <td>
              <div id="addCommodityIndex2">
                <div class="input-group row">
                    <div class="col-sm-12 big-photo">
                      <div id="preview2">
                            <img id="imghead" border="0" src="http://localhost/tpdemo/1/Application/Home/Public/images/photo_icon.png" width="50" height="50"  onclick="$('#previewImg2').click();">
                         </div>         
            ...
            <td>
              <div id="addCommodityIndex3">
                <div class="input-group row">
                    <div class="col-sm-12 big-photo">
                      <div id="preview3">
                            <img id="imghead3" border="0" src="http://localhost/tpdemo/1/Application/Home/Public/images/photo_icon.png" width="50" height="50"  onclick="$('#previewImg3').click();">
                         </div>         
            ...
            <td>
              <div id="addCommodityIndex4">
                <div class="input-group row">
                    <div class="col-sm-12 big-photo">
                      <div id="preview4">
                            <img id="imghead4" border="0" src="http://localhost/tpdemo/1/Application/Home/Public/images/photo_icon.png" width="50" height="50"  onclick="$('#previewImg4').click();">
                         </div>         
            ...
            <td>
              <div id="addCommodityIndex5">
                <div class="input-group row">
                    <div class="col-sm-12 big-photo">
                      <div id="preview5">
                            <img id="imghead5" border="0" src="http://localhost/tpdemo/1/Application/Home/Public/images/photo_icon.png" width="50" height="50"  onclick="$('#previewImg5').click();">
                         </div>         
            ...
            <td>
              <div id="addCommodityIndex6">
                <div class="input-group row">
                    <div class="col-sm-12 big-photo">
                      <div id="preview6">
                            <img id="imghead6" border="0" src="http://localhost/tpdemo/1/Application/Home/Public/images/photo_icon.png" width="50" height="50"  onclick="$('#previewImg6').click();">
                         </div>         
