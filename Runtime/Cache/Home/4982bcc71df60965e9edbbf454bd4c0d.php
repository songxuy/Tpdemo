...
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no">
  ...
  <script src="http://localhost/tpdemo/1/Application/Home/Public/js/verificationNumbers.js" tppabs="js/verificationNumbers.js"></script>
  <script src="http://localhost/tpdemo/1/Application/Home/Public/js/Particleground.js" tppabs="js/Particleground.js"></script>
  <script type="text/javascript" src="http://localhost/tpdemo/1/Application/Home/Public/js/jquery-validate.js"></script>
  <link rel="stylesheet" type="text/css" href="http://localhost/tpdemo/1/Application/Home/Public/css/style.css" tppabs="css/style.css" />
</head>
<style>
*{
  padding:0px;
