...
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no">
	<title>管理员中心</title>
	<script type="text/javascript" src="http://localhost/tpdemo/1/Application/Admin/Public/js/jquery-3.1.1.min.js"></script>
  <script src="http://localhost/tpdemo/1/Application/Admin/Public/js/jquery.slimscroll.min.js"></script> 
  <script type="text/javascript" src="http://localhost/tpdemo/1/Application/Admin/Public/bootstrap/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="http://localhost/tpdemo/1/Application/Admin/Public/js/validator.js"></script>
  <script type="text/javascript" src="http://localhost/tpdemo/1/Application/Admin/Public/js/jquery-validate.js"></script>
   <script type="text/javascript" src="http://localhost/tpdemo/1/Application/Admin/Public/js/index1.js"></script>
  <link rel="stylesheet" type="text/css" href="http://localhost/tpdemo/1/Application/Admin/Public/bootstrap/css/bootstrap.min.css"/>
  <link rel="stylesheet" type="text/css" href="http://localhost/tpdemo/1/Application/Admin/Public/css/font-awesome.min.css"/>
   <link rel="stylesheet" type="text/css" href="http://localhost/tpdemo/1/Application/Admin/Public/css/validator.css"/>
</head>
<body>
<style>
* { margin: 0; padding: 0 }
