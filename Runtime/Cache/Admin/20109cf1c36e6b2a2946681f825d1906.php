  ...
  <div class="col-sm-3 s_nav">
    <div class="navMenubox">
      <div id="slimtest1">
        ...
        <ul class="navMenu">
          <li> <a href="javascript:;" class="afinve"> <i class="icon_1"></i> <span class="">用户审核</span></a> </li>
          <!--<li> <a href="javascript:;" class="afinve"> <i class="icon_1"></i> <span class="">发布通知</span></a></li>-->
          <li > <a href="javascript:;" class="afinve"> <i class="icon_2"></i> <span class="nav-text">考试管理</span> <span class="arrow"></span> </a>
            <ul class="sub-menu s1">
              <li><a href="javascript:;" ><span>考试列表</span></a></li>
              <!--<li><a href="javascript:;"><span>考试报名信息审核</span></a></li>-->
              <li><a href="javascript:;"><span>考试安排</span></a></li>
              <li><a href="javascript:;"><span>安排座次</span></a></li>
              <li><a href="javascript:;"><span>考试成绩录入</span></a></li>
              <li><a href="javascript:;"><span>考试成绩查询</span></a></li>
              <li><a href="javascript:;"><span>考试结束管理</span></a></li>
            </ul>
          </li>
          <li > <a href="javascript:;" class="afinve"><i class="my-icon nav-icon icon_2"></i><span>合格证管理</span><span class="arrow"></span></a> 
            <ul class="sub-menu s2">
              <li><a href="javascript:;" ><span>合格证核发</span></a></li>
            </ul>
          </li>
        </ul>
      </div>
  ...
  <div class="div1">
    ...
    <form action="#" id="search_box" style="margin-left:100px;">
      <div class="wrapper">
        ...
        <button type="submit" class="search_btn"><img src="http://localhost/Application/Admin/Public/images/search_icon.png" title="Search" /></button>
      </div>
    </form>
    ...
    <div class="zuoci" style="display:none;">
      ...
      <p>统计安排考试共<span id="examnum"><?php echo $examcount;?></span>场</p>
...
<script>
  $(function(){
    ...
    for(var i=0;i<examnum;i++){
      if(i!=examnum-1){
      $('#paizuoci').append(`<p class="text-info">第`+(i+1)+`场考试</p><div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-2 input-parent" >
          <select class="form-control vinput" name="day">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="ksnumber" name="ksnumber">
        </div>
      </div>`)}else{
        $('#paizuoci').append(`<p class="text-info">第`+(i+1)+`场考试</p><div class="form-group">
        <label for="name" class="col-sm-2  control-label">考试准确地点 :</label>
      ...
      <div class="form-group" style="float:right;">
        <div class="col-sm-12 input-parent" >
            <button type="submit" class="btn btn-primary">生成座次</button>
            <button type="reset" class="btn btn-default">取消</button>
        </div>
      </div>`)
    ...
    $('.navMenu .s2>li').click(function(){
      var oo2=$(this).index();
      $('.ss_nav .div1 div').hide();
      $('.ss_nav .div2 div').hide();
      $('.ss_nav .div3>div').eq(oo2).show().siblings().hide();
      $('.ss_nav .div3>div').eq(oo2).find('div').show()
    })
