        ...
        <ul class="navMenu">
          ...
          <li > <a href="javascript:;" class="afinve"> <i class="icon_2"></i> <span class="nav-text">考试管理</span> <span class="arrow"></span> </a>
            <ul class="sub-menu s1">
              ...
              <li><a href="<?php echo U('Exammanage/anpaiks');?>"><span>安排考试</span></a></li>
              <li><a href="<?php echo U('Exammanage/anpaizc');?>"><span id="anpaicuo">安排座次</span></a></li>
...
<div class="zuoci col-sm-9" style="margin-top:20px;">
      <p class="alert alert-warning">安排座次<span class="glyphicon glyphicon-menu-right" ></span></p>
      <p>统计安排考试共<span id="examnum">2</span>场</p>
      <form class="form-horizontal" id="paizuoci">
      </form>
</div>
<footer>
   ...
   var examnum=document.getElementById("examnum").innerHTML;
    for(var i=0;i<examnum;i++){
      ...
      $('#paizuoci').append(`<p class="text-info">第`+(i+1)+`场考试<span style="color:red;">(时间输入规范：2017年05月01号08:00-10:00)</span></p>
        ...
        <label for="name" class="col-sm-2  control-label">考试科目 :</label>
        <div class="col-sm-10  input-parent">
          <select class="form-control vinput" name="examSub" id="examSub`+i+`">
          	<option value="防雷检测">防雷检测</option>
          </select>
        </div>
      </div>
      	<div class="form-group">
        ...
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="ksplace`+i+`" name="ksplace" class="place">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="ksnumber`+i+`" name="ksnumber">
        </div>
      </div>`)}else{
        $('#paizuoci').append(`<p class="text-info">第`+(i+1)+`场考试<span style="color:red;">(时间输入规范：2017年05月01号08:00-10:00)</span></p>
        	<div class="form-group">
      ...
      <div class="form-group" style="float:right; margin-bottom:100px;">
        <div class="col-sm-12 input-parent" >
            <button type="button" class="btn btn-primary" id="trans">生成座次</button>
            <button type="reset" class="btn btn-default">取消</button>
        </div>
      </div>`)
    }
